...
![单双链表对比|560](./img/2.2-单双对比.png)

![单链表带头对比|580](./img/2.3-带头对比.png)

![循环对比|520](./img/2.4-循环对比.png)

虽然有这么多的链表的结构，但是我们实际中最常用还是两种结构：

![结构复杂度对比|650](./img/2.5-常用链表类型.png)
