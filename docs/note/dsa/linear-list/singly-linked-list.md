...
![链表示意图](./img/2.1-链表示意图.png){:width="535"}
...
![单双链表对比](./img/2.2-单双对比.png){:width="561"}

![单链表带头对比](./img/2.3-带头对比.png){:width="584"}

![循环对比](./img/2.4-循环对比.png){:width="515"}

虽然有这么多的链表的结构，但是我们实际中最常用还是两种结构：

![结构复杂度对比](./img/2.5-常用链表类型.png){:width="651"}
...
![img](./img/2.6-头指针头结点.png){:width="577"}
