...
declare const __DECO_IMG__: string;
declare const __DECO_PATHS__: string[];

const img = __DECO_IMG__;
let test = __DECO_PATHS__;

// vite 可以处理 import { default as style } from "foo.css"

export default defineClientConfig({
    rootComponents: [Background],
