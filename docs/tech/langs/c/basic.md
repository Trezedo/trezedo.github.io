...
```c
int main() {
    int i_2 = 0b01111011; // 2 进制，以 "0b" 开头
    int i_8 = 0173; // 8 进制，以数字 "0" 开头
    int i_10 = 123; // 10 进制
...
```c
float f = 1.234;
printf("浮点数 f = %f", f); // %f 是以浮点数形式输出数据
```
