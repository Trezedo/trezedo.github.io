...
![链表示意图|540](https://zedo.gitee.io/img/2.1-链表示意图.png)
...
![单双链表对比|560](https://zedo.gitee.io/img/2.2-单双对比.png)

![单链表带头对比|580](https://zedo.gitee.io/img/2.3-带头对比.png)

![循环对比|520](https://zedo.gitee.io/img/2.4-循环对比.png)

虽然有这么多的链表的结构，但是我们实际中最常用还是两种结构：

![结构复杂度对比|650](https://zedo.gitee.io/img/2.5-常用链表类型.png)
...
![img|580](https://zedo.gitee.io/img/2.6-头指针头结点.png)
...
由于该部分占用了较大篇幅，且单链表是最常考察的知识点，请前往[单链表练习](./q/sll.md)。
