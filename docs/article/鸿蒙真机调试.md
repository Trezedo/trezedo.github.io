...
![设备 uuid 截图](https://zedo.gitee.io/img/image-20220629091923447.png)
...
![用户与访问](https://zedo.gitee.io/img/image-20220629092335701.png)

在左侧导航栏下方选择“设备管理”，进入设备管理页面。

![设备管理-1](https://zedo.gitee.io/img/image-20220629092339931.png#s-50)

页面中选择添加设备，在弹出窗口填写设备信息，点击“提交”。

![设备管理-2](https://zedo.gitee.io/img/image-20220629092347049.png)

![填写设备信息](https://zedo.gitee.io/img/image-20220629092358513.png)

这里的 UUID 就是上面用工具获取到的。

添加完成：

![添加完成截图](https://zedo.gitee.io/img/image-20220629094423431.png)

## 创建项目

同样在 [AppGallery Connect](https://developer.huawei.com/consumer/cn/service/josp/agc/index.html)，选择“我的项目”：

![我的项目](https://zedo.gitee.io/img/image-20220629095849535.png)

点击 “添加项目”，然后填写项目名称：

![添加项目](https://zedo.gitee.io/img/image-20220629100100869.png)

完成后点击 “添加应用”：

![添加应用](https://zedo.gitee.io/img/image-20220629100233809.png)

填写表单，应用包名就是 DevEco 项目的包名，最后确定即可：

![表单截图](https://zedo.gitee.io/img/image-20220629100408107.png)
...
![DevEco 签名](https://zedo.gitee.io/img/image-20220629101540249.png)

之后就能使用真机运行我们的 APP 了（小吐槽：远程真机和模拟器是真的卡）。

![连接真机截图](https://zedo.gitee.io/img/image-20220629101617206.png)
